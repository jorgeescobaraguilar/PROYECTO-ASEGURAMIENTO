...
namespace TestProject1
{
    ...
    public class PruebaUnitaria4
    {
        ...
        public void ThePruebaUnitaria2Test()
        {
            ...
            driver.FindElement(By.XPath("//li[5]/a/i")).Click();
            Assert.AreEqual("Administrar clientes", driver.FindElement(By.XPath("(.//*[normalize-space(text()) and normalize-space(.)='Inicio'])[2]/following::li[1]")).Text);
        }
